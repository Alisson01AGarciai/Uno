...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!inicio) {
            ...
            System.out.println("¿Quieres jugar con bots o con amigos?");
            System.out.println("1 ¿Quieres jugar con un bot?");
            ...
            if (seleccion == 1) {
                ...
                while (!bots) {
                    ...
                    if (bot == 1) {
                        ...
                        System.out.println("solo se pueden tener tres bots");
                    }
                }
            } else if (seleccion == 2) {
                ...
                while (!jugadores) {
                    ...
                    if (player == 1) {
                        ...
                        System.out.println("solo se pueden tener cuatro jugadores");
                    }
                }
        ...
        int[] Baraja;  //DECLARAMOS EL ARREGLO
        Baraja = new int[129]; //DECLARACION DEL PROYECTO
        int carta = 0, reversa = 0; //0 es que reversa esta desactivada
        int[] player_1;
        player_1 = new int[8];
        int[] player_2;
        player_2 = new int[8];
        ...
        for (int aux = 1; aux <= 120; aux++) {
            Baraja[aux] = cara;
            System.out.println("Arreglo en posición: " + aux + " tiene un: " + Baraja[aux]);
            if (carta == 9) {
                carta = 0;
            } else {
                if (carta != 9)
        ...
        for (int b = 1; b <= 7; b++) { //llenar baraja jugador 1
            ...
            jugador_1[b] = Baraja[a];
            Baraja[a] = 70; //CARTA OCUPADA
            System.out.println("Carta: " + b + " :::::" + jugador_1[b] + " posicion de baraja " + a);
        }

        for (int aux = 1; aux <= 128; aux++) {
            if (Baraja[aux] != 70) {
                System.out.println(Baraja[aux]);
                System.out.println("CARTA: " + aux + " :::: la posicion de la carta es: " + Baraja[aux]);
            } else {
